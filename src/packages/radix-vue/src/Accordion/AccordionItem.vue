...
export interface AccordionItemProps
  extends /* @vue-ignore */ Omit<CollapsibleRootProps, 'open' | 'defaultOpen' | 'onOpenChange'> {
  /**
...
const open = computed(() =>
  rootContext.isSingle.value
    ...
    : Array.isArray(rootContext.modelValue.value) && rootContext.modelValue.value.includes(props.value)
);
...
function handleArrowKey(e: KeyboardEvent) {
  useArrowNavigation(e, currentElement.value, rootContext.parentElement.value!, {
