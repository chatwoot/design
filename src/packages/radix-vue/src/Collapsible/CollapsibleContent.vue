...
export interface CollapsibleContentProps extends /* @vue-ignore */ PrimitiveProps {
  /**
...
<template>
  <Presence ref="presentRef" :present="forceMount || rootContext.open.value" :force-mount="true">
    <Primitive
      v-bind="$attrs"
